...
function ShelfPending({ classroom }) {
  return (
    <div className="flex flex-col justify-center items-center bg-warning w-100 h-fit px-8 py-8 space-y-2 rounded-xl">
      <div>
        <ShieldExclamationIcon className="size-14 text-warning-content" />
      </div>
      <p className="text-2xl text-warning-content font-bold">Request is pending</p>
      <p className="text-sm text-warning-content text-center opacity-80">
